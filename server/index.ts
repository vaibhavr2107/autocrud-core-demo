...
(async () => {
  ...
  // Create HTTP server manually since we're using existing app
  ...
  server.listen({
    ...
    log(`AutoCRUD REST API available at http://localhost:${port}/api`);
    log(`AutoCRUD GraphQL API available at http://localhost:${port}/graphql`);
  });
})();
